# OSRIC — Monsters: Devils, Dinosaurs, Golems, Lycanthropes

*OSRIC, Chapter V, book pages 225–239.*
*Entries: Uduk (continued from previous file); Devils — Assagim, Barbed Devil, Bearded Devil, Bone Devil, Devilcat, Erinyes, Horned Devil, Ice Devil, Imp, Lemure, Scaly Devil, Shaitan, Spiked Devil, Pit Fiend, Soul Worm (15); Dinosaurs — 8 headed groups (Tyrannosaurids and Allosaurids, Hadrosaurids, Sauropods, Ceratopsians, Other Dinosaurs I, Other Dinosaurs II, Marine Dinosaurs, Flying Dinosaurs) covering 47 named species; Golems (1 heading, 4 types: Clay, Flesh, Iron, Stone); Lycanthropes (1 heading, 5 types: Werebear, Wereboar, Wererat, Weretiger, Werewolf). 26 headed sections total.*
...
Devil society is organized into a strict hierarchy, which is never compromised for fear of retribution from the archdevils, who rule the planes of Hell. Nevertheless,

<!-- p.226 -->

squabbling and rivalries are common amongst devils. Amongst the archdevils themselves there also exists a hierarchy of barons, dukes, marquises, and princes—cause for considerable rivalry and jealousy.
...
### Assagim *(Least Devil; Nipheribu, Ashashimu, Nishershimu)*
...
### Bearded Devil *(Lesser Devil; Barbazu, Tothmys, Thissuzim)*
...
### Bone Devil *(Lesser Devil; Osyluth, Gerotephys, Calcinnim)*
...
### Horned Devil *(Greater Devil; Cornugon, Malibranchai)*
...
(PDF 249, book p.237) — this is genuinely what is printed, not an extraction
artefact; reproduced as printed. -->
