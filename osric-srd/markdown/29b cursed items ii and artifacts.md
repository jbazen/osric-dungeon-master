# OSRIC — Cursed Items II and Artifacts

*OSRIC, Chapter VI (Treasure), book pages 368–374.*
*Entries: Net of Snaring … Vacuous Grimoire (16 cursed items); Book of Infinite Spells … Talisman of Pure Evil (9 artifacts). Plus the ARTIFACTS section intro, the MINOR ARTIFACT DESCRIPTIONS sub-heading, the Dread Wraith monster stat block embedded in the Deck of Many Things entry, and the closing MAJOR ARTIFACTS section (25 named entries plus 4 unnamed sections in total).*
