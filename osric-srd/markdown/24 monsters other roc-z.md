# OSRIC — Monsters, Other Creatures (Roc–Yeti)

*OSRIC, Chapter V, book pages 305–320.*
*Entries: Roc, Roper, Rot Grub, Rust Monster, Sahuagin, Scorpion, Sea Hag, Sea Serpent, Shambling Mound, Shedu, Shrieker, Skeleton Warrior, Slithering Tracker, Slime (Green), Slug (Giant), Snake (Giant), Sphinx, Sphinx (Andro-), Sphinx (Crio-), Sphinx (Gyno-), Sphinx (Hieraco-), Spider (Giant), Spider (Huge), Spider (Large), Spider (Phase), Spider (Giant Water), Squealer, Stirge, Stunjelly, Tick (Giant), Titan, Trapper, Triton, Vilstrak, Volt, Vulchling, Wasp (Giant), Will-O-the-Wisp, Wyvern, Xorn, Yeti (41 entries).*
...
| **Move:** | 120 ft; 240 ft swimming | 120 ft; 240 ft swimming | 120 ft; 240 ft swimming | 120 ft; 240 ft swimming | 120 ft\; 240 ft swimming<!-- printed as-is: see errata E3 --> |
...
A typical squealer is the size and weight of a large gorilla, and has a third arm protruding from its back. It depends from this extra arm and its prehensile feet while attacking
...
Titans are powerful creatures not native to the material plane. They normally appear as massive humans, well-figured and possessed of an unearthly beauty. The

<!-- p.317 -->

movement rate, armour class, and damage caused by titans is as follows:
...
of water, and are found in the elemental plane of water as well as in the prime material plane. Groups of tritons are composed as follows:
