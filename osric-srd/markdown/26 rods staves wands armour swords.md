# OSRIC — Rods, Staves, Wands, Armour & Swords

*OSRIC, Chapter VI (Treasure), book pages 333–344 (partial).*
*Entries: Absorption … Trident/Fork (58 named entries). Also includes the book's full "Unusual Swords" rules subsystem (intelligence, alignment, minor/major powers, special purpose, ego) and the "A Battle of the Wills: Swords vs Characters" section — general system prose, not named entries.*

<!-- p.333 -->

## RODS, STAVES AND WANDS

These devices are relatively similar in nature, but vary in appearance and effect. Wands are the smallest of these, usually being about 1 ft long and narrow. Rods are the

<!-- p.334 -->

next largest, about 3 ft long and ¾ in thick. Staves are the largest, usually being 6 ft long and about 2 in thick. Wands and rods can be made of wood, metal, ivory, or any combination of these materials, and are most often found inside of a special case. Any staff will be made of wood, unless otherwise noted, with ornate carving and complex shape.
...
The *staff of power* is a very potent magic item, with offensive and defensive abilities. Each of the

<!-- p.336 -->

following spell-like powers cost 1 charge: *magic missile, ray of enfeeblement, continual light, darkness 15 ft radius, levitate, lightning bolt, fireball,* and *cone of cold*.
...
Like other *wands of detection*, this wand will vibrate and point to the item

<!-- p.337 -->

it is enchanted to detect, in this case, the largest quantity of a mineral or metal within a 30 ft range. The wand may also be used to detect all samples of a specific mineral or metal within range, such as gold or diamonds. The wielder of the wand becomes aware of the quantity of the item when detected. This wand requires 1 round per use, and may be used continuously for 1 turn per charge spent. The *wand of detecting minerals and metals* can be recharged.
...
A *wand of wonder* is a strange and unpredictable device that randomly generates any number of weird effects each time it is used. Each use costs 1 charge.
...
reduces the AC bonus to +4, but note the AC bonus is always at least +1, even if all charges are expended. This magical armour cannot be recharged by any means.
...
The *frost brand* is normally +3, granting a +6 bonus against any creature using fire as
...
special purpose, and an ego. This section will allow the GM to create unusual swords for use in his or her campaign.
...
will only seek to kill evil clerics). Good swords dedicated to slaying monsters will always slay neutral or evil monsters, while evil swords dedicated to slaying monsters will always slay neutral or good monsters.
...
If the personality score of the sword should ever become greater than that of the wielder, the sword will be able to dominate the player. The sword will be able to force any or all of the above upon the unfortunate player and,
...
A +1 dagger which, on a natural hit roll of 20, injects a dose of lethal poison into its victim,

<!-- p.344 -->

though the target gets a saving throw vs poison to negate. The dagger can hold six doses of poison in a tiny compartment in the hilt and can be refilled. Use of this weapon by good aligned characters should be closely monitored.

#### Hammer of the Dwarfs (F)

Usually functions as a +2 hammer. In the hands of a dwarfish fighter who knows the command word, however, this weapon is a full +3 warhammer. The *hammer of the dwarfs* retains its attack bonus when hurled as a missile weapon, doing double damage if it hits and boomeranging back to its owner. If thrown at a giant opponent (including ogres, trolls, and ettin) the hammer will cause triple damage if it hits.
