...
*OSRIC, Chapter III, book pages 133–144, plus the closing "General Note" paragraph on book p.145 (printed before the next section's heading; see transcriber's boundary note).*
*Sections: Hirelings and Henchmen (overview); Standard Hirelings (rate table, 12 role entries); Expert Hirelings (wage table; Men at Arms table; Ship Crew table; Armour Type and Skill Level table; Blacksmith Weapon Type table; Mercenary frequency table; 19 Men-at-Arms role entries; Sage subsection with Sage Ability Table, seven Sage Fields of Study category tables, Chance-of-Knowing table, Sage Characteristics stat block, Sage Alignment table, Information Discovery Time and Cost table; six Ship-crew role entries; Spy and Steward entries; Weaponer entry and Weapon Type table); Henchmen (recruitment and negotiation mechanics, Henchman Class table); Loyalty of Hirelings and Henchmen (nine modifier tables, Loyalty Test table). 30 tables in total, including the Henchman Class table (errata E4).*
...
- **Bowman (Mounted):** Skilled at shooting from the saddle, but generally unwilling to close to melee; mounted bowmen have a reputation for poor discipline. Typical equipment includes a light warhorse with gear, studded armour, short bow, quiver with twelve arrows, and hand axe.
...
- **Footman, Light:** Accustomed to fighting in open order and traversing broken or rough terrain, light footmen are armed and armoured accordingly. Typical equipment includes studded armour, large shield, spear, and hand axe.
...
- **Horseman, Heavy:** Most effective when attacking in very close order on open terrain, heavy horsemen are

<!-- p.138 -->
  well armed and fearsome in combat. Typical equipment includes a heavy warhorse with gear, mail barding, mail armour, large shield, lance, long sword, and dagger.
- **Horseman, Medium:** Capable of delivering a powerful charge over open ground and in close order, well used medium horsemen can prove decisive. Typical equipment includes a medium warhorse with gear, scale barding, scale armour, large shield, lance, broad sword, and dagger.
