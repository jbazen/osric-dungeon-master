# OSRIC — Time, Movement and Combat

*OSRIC, Chapter III, book pages 122–132, plus the opening of p.133 (through the end of the Insanity descriptions, before the "Hirelings and Henchmen" heading that starts the next file).*
*Sections: Time Measurement · Movement · Encumbrance and Base Movement Rate · Gaining Levels · Experience · Light and Vision · Infravision · Falling · Item Saving Throws · Combat · Combat Actions · Combat Modifiers · Attack and Saving Throw Matrices for Monsters · Turning the Undead · Damage and Death · Natural Healing · Subdual Damage · Life Energy Levels and Level Drain · Morale · Poison, Disease and Insanity (18 headed sections, 9 tables — 3 of them printed split across a page or column break with their header repeated — and 4 illustrations).*
...
a character. The bulk of listed armour and items is already taken into account for purposes of convenience.
...
| Item Type | Acid | Blow, Crushing | Blow, Normal | Cold, Magical | Disintegrate | Electric Shock | Fall (5ft) | Fireball | Fire, Magical | Fire, Normal | Lightning |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
<!-- printed as-is: see errata E8 — Paper row prints Fireball 25 and Fire, Magical 21, both impossible on a d20 -->
<!-- printed as-is: see errata E9 — Paper row prints 0 under Fall (5ft); Liquid row prints 0 under Blow, Crushing, Blow, Normal and Fall (5ft), where "—" is used elsewhere in the book for not-applicable -->
...
Combat actions normally should be declared by the players, and decided by the GM, prior to the initiative die being rolled. Certain actions, of course, are so integral to the game that methods for their resolution are set forth as

<!-- p.127 -->

rules. These actions are: fleeing, negotiating, holding initiative, firing missiles, setting weapons against a charge, attacking, casting spells, and engaging in unarmed combat. Each of these common actions is described below.
...
the weapon will inflict double damage against a charging opponent. A charge is any attack that allows the attacker to move and attack, and thus includes leaping attacks that may be made by some monsters.
...
the GM should use discretion in following this guideline; in cases where the monster clearly possesses the abilities of another class, consideration should be given to using that matrix instead. (A good example might be a goblin shaman, which could save as a cleric instead of a fighter.)
...
*[Illustration: a horned demon standing over two skeletal figures, one bearing a shield.]*
...
**Turning Undead Table** *(continued; header repeated as printed)*
...
Certain monsters, such as trolls or most undead creatures, are fearless and never need to check morale. The majority, however, will not continue to fight a hopeless battle, seeking to retreat, surrender, or flee.  The GM determines when morale checks should be made.  Generally, morale

<!-- p.131 -->

should be checked when it becomes clear that the monsters are losing the fight, or taking unacceptable losses. No more than two morale checks should be made per battle, however; if the monsters pass a second morale check, they are assumed to be fanatical and will fight to the death.
...
**Table of Common Morale Check Modifiers (all cumulative)** *(continued; header repeated as printed)*
...
Diseases in OSRIC-compatible games often come from monsters, such as mummies or giant rats, in which case
...
*[Illustration: a stone dungeon corridor with an arched ceiling and a stream of water running through it.]*
...
<!-- This d% table breaks across the column gutter on book p.132. The second half repeats the "d% / Insanity" header exactly as printed — the printed page does NOT omit the repeat here, contrary to the working note that this table lacks a repeated header; that note appears to be mistaken for this instance and is flagged for the coordinator. -->
