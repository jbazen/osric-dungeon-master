# OSRIC — An Example Dungeon and Sample Play Session

*OSRIC, Chapter III — How to Play, book pages 153–156.*
*Second of two files (14a/14b) split at dispatch from the original "14 exploration town planes" range (book pp.145–156); 14a covers pp.145–152, this file continues from it at book p.153. Entries: 2 named sections — An Example Dungeon (with Example Dungeon Key and a 5-room Map Key) at p.153, and Sample Play Session (Background plus an unbroken GM/player dialogue transcript) at pp.153–156. Also contains: one unheaded closing fragment of the preceding "Exploring the Planes" section carried over onto p.153 before the first heading here, and two figure pointers (p.153 cave-mouth illustration, p.154 dungeon map) — see 34 figures.md.*

<!-- p.153 -->

By that stage, the authors hope, the GM will be sufficiently experienced to cope with the situation and indeed enjoy rising to the challenge. The authors would like, in the fullness of time, to release an optional supplement or supplements about the planes, but this will not form part of the OSRIC core rules.

## AN EXAMPLE DUNGEON

<!-- FIGURE p.153: see 34 figures.md -->
...
<!-- FIGURE p.154: see 34 figures.md -->
...
**Eric:** Okay, from where I’m standing I poke into the stream with my shortsword. How deep is it? How swiftly is it moving?
...
and so is Hogarth. Floppinjay and the 2 orcs who were on him are out of the area of effect.
