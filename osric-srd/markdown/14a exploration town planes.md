# OSRIC — Exploration, Town and the Planes (I)

*OSRIC, Chapter III — How to Play, book pages 145–152. First of two files (14a/14b) covering the original “exploration town planes” dispatch range; continues in 14b, which opens with “An Example Dungeon” at book p.153.*
*Sections: Adventure and Exploration (p.145) with subsection Searching the Dungeon (p.145) · Exploring the Wilderness (p.150) · Aerial Agility (p.151) with subsection Special Cases (p.151) · Adventures in Town (p.151) · Exploring the Planes (p.152). Seven headed sections, no discrete entries. Book p.145 is a shared page: it opens with a trailing "General Note:" paragraph that closes out the preceding Hirelings and Henchmen discussion — that paragraph is carried in file 13 (the earlier file, per the project's shared-page convention), not here. This file begins at the "Adventure and Exploration" heading, which starts partway down p.145.*
...
The players should establish, and the party caller inform the GM of, the party’s “marching order”, i.e. which characters are in front, the middle, and bringing up the rear. In a standard 10 ft wide dungeon corridor, up to three characters may walk abreast, though if any are wielding large weapons such as flails or two-handed swords, this may be reduced to two characters or even one. Characters in the second rank may only attack with a long weapon, such as

<!-- p.147 -->

a spear or pole arm, or if they are firing missiles over the head of a shorter character such as a gnome or halfling.
...
Furthermore, once a door is opened, it is usually difficult to keep it open, or for that matter to keep it closed. OSRIC has a double-standard that while adventurers may have a hard time opening doors in dungeons, monsters have no such

<!-- p.148 -->

trouble and can open doors automatically unless the players prevent them. The usual way to hold a dungeon-door open or closed is to wedge it with iron spikes. Even then there is a small chance (at the GM’s discretion but often around 20-30%) that a spiked door will slip.
...
Beyond these sorts of pre-defined activities OSRIC has no specific system for resolving most other tasks. This is intentional—the player characters are heroes, and should be able to do most mundane things without a roll. Certainly the authors could have included a skill system covering activities such as “horse riding” or “swimming”,
...
2. **Lost:** The party will never become lost if following a road, river or other natural feature, nor if they are following an accurate map, nor if they are travelling over terrain at least one party member knows well. (This could include an NPC guide if one is hired for the purpose.)
   ...
   If the party does become lost, determine their actual direction of travel randomly. In most cases they will

<!-- p.151 -->

   go somewhere within a 60° arc in front of them, but if the roll is particularly bad, the GM may adjust this to 120°. Only in exceptional circumstances will the party get completely turned around.
...
4. **Movement and Stationary Actions:** See the previous section (on dungeons) and the Movement Rate section in Chapter II.
...
Most activities that characters perform “in town”, such as gathering information, hiring men-at-arms or guides, purchasing equipment, liquidating treasure, resting and

<!-- p.152 -->

healing, hiring NPC spell-casters to identify unknown magic items or remove afflictions, training to gain new levels, etc. can be handled abstractly. It occurs “offstage”—the players make notes in their records (adding or subtracting the corresponding amounts of gold), the GM notes the number of days that have passed, and the game resumes when the players are next ready to venture into the dungeons or wilderness.
