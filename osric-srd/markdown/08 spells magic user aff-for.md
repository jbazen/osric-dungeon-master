# OSRIC — Magic User Spells, Affect Normal Fires–Forget

*OSRIC, Chapter II, book pages 70–84.*
*Entries: Affect Normal Fires … Forget (65 entries).*
...
- **Area of Effect:** Area 10 ft cube/ level, or a single object.
- **Components:** V,S,M
...
either be familiar to the caster or be obvious, such as the top floor inside a tower the caster can see, or just beyond a dungeon door.
...
<!-- illustration: two unlabelled elemental-creature figures, no caption text -->
...
Except as may be noted above, this spell is identical to the clerical spell *control weather*.
...
Except as noted above, this spell is identical to the clerical spell *dispel magic*.
...
<!-- illustration: unlabelled sword illustration, no caption text -->
...
Except as may be noted above, this spell is identical to the druidic spell *feeblemind*.
