# OSRIC — Dungeons and Dungeon Generation

*OSRIC, Chapter IV, book pages 157–173.*
*Sections: Dungeons (dungeon dressing tables); Trap Generation and Placement; Tricks; Random Dungeon Generation (Tables 1–24); Random Encounters (Monster Sub-Table Matrix, Monster Level One–Ten and their Dragon Sub-tables); NPC Parties (All Dungeon Levels, including Party Magic Items Sub-Tables 1–4). Book p.173 is shared with file 16a — this file owns Sub-Table 2's tail and Sub-Tables 3–4; file 16a begins at the "RANDOM URBAN ENCOUNTERS" heading further down the same page.*
...
Printed as three parallel alphabetised columns of unequal length; reading order is column 1 top to bottom, then column 2, then column 3, each column continuing across the page break below.

Column 1 (p.160): Antechamber, Armoury, Audience-, Aviary, Banquet-, Barracks, Bath.

Column 2 (p.160): Entry-, Gallery, Game Room, Great Hall, Guardroom, Hall, Hallway.

Column 3 (p.160): Secret-, Seraglio, Shrine, Sitting Room, Smithy, Solar, Stable.
<!-- p.161 -->
Column 1 (continued): Bedroom, Bestiary, Boudoir, Cell, Chantry, Chapel, Cistern, Class-, Closet, Conjuring-, Corridor, Court, Crypt, Dining-, Divination-, Dormitory, Dressing Room.

Column 2 (continued): Harem, Kennel, Kitchen, Labouratory<!-- printed as-is: see errata E13 -->, Library, Lounge, Meditation, Observatory, Office, Pantry, Pen, Prison, Privy, Reception, Refectory, Robing-, Salon.

Column 3 (continued): Storage, Strongroom, Study, Temple, Throne Room, Toilet, Torture Chamber, Training, Trophy Room, Vault, Vestibule, Waiting Room, Water Closet, Well, Workroom, Workshop.
...
*refer to Table 3: Special Rooms or Chambers.
<!-- p.164 -->
<!-- FIGURE p.164: see 34 figures.md -->
...
| 31-35 | Devil, Scaly devil; (1-2) Black; (3-4) Blue; (5-6) Green, (7-8) White | 1d3 |
| 36-40 | NPC Party – see Sub-table | varies |
...
| 16-20 | Roll d6 1-3: Staff of the Serpent (CD)<br>4-6: Staff of Compulsion (CM) |
